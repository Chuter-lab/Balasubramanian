...
class Visualizer:
    ...
    #MB: 4/12/2024 - changes to add jittering
    #def draw_dataset_dict(self, dic):
    def draw_dataset_dict(self, dic, jittering: bool = True, 
                          outline_linewidth=1.0, outline_linestyle='--'):
        """
        ...
        if annos:
            ...
            #MB: March 20, 2024
            #print(f"type(masks): {type(masks)}; masks: {masks}")
            ...
            #MB: April 12, 2024 - changes as in draw_instance_predictions
            #if self._instance_mode == ColorMode.SEGMENTATION and self.metadata.get("thing_colors"):
            #    colors = [
            ...
            #MB: March 20, 2024
            #print(f"names: {names}")
            #names = [] #to force to print the category_id
            ...
            #)
            self.overlay_instances(
                labels=None, boxes=None, masks=masks, keypoints=keypts, assigned_colors=colors, alpha=0.5,
                outline_linewidth=outline_linewidth, outline_linestyle=outline_linestyle
            )
