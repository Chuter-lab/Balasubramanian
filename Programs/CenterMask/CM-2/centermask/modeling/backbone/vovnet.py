...
from .fpn import LastLevelP6, LastLevelP6P7, LastLevelP5P6
...
class VoVNet(Backbone):
    ...
    def __init__(self, cfg, input_ch, out_features=None):
        ...
        #print(f"VoVNet: out_features: {self._out_features}; \n \
        #      \t out_feature_strides: {self._out_feature_strides}; \n \
        #        \t out_feature_channels: {self._out_feature_channels}")
...
def build_fcos_vovnet_fpn_backbone(cfg, input_shape: ShapeSpec):
    ...
    if top_levels == 2:
        #MB - 20240814 - Added support for p5 and p6
